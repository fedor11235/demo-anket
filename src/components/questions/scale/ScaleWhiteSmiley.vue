<template>
  <div
    class="question question--scale question--scale-smile question--scale-smile-monochrome"
  >
    <QuestionTitle
      :no="questionNumber"
      :title="title"
            ...
            <tr v-for="item of scale" :key="item.id">
              ...
              <td>
                <div class="question__row-flex">
                  ...
                  >
                    <i
                      class="question__icon question__icon--smile question__icon--smile-mono question__icon--lg"
                    ></i>
                  </span>
                </div>
              </td>
